...
HD_PWD='C:/VivadosBeingAProblem/AES/FullControllerGPIO/FullController2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FullControllerBlockDesign_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FullControllerBlockDesign_wrapper.tcl
