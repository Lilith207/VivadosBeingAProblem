...
HD_PWD='C:/Users/freek/OneDrive/Bureaublad/Mechatronics/AES/AES7-main/week_2/debug_example/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TwoAddersMultiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TwoAddersMultiplier.tcl
